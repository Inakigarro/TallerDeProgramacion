...
namespace Ejercicio_2
{
    class FachadaEjercicio2
    {
        ...
        {
            if (pCuentaEnPesos.DebitarSaldo(pSaldo * valorDolar))
            {
                pCuentaEnDolares.AcreditarSaldo(pSaldo);
            }
            else
        ...
        public bool AcreditarSaldoDeDolarAPeso(Cuenta pCuentaEnDolares, Cuenta pCuentaEnPesos, double pSaldo)
        {
